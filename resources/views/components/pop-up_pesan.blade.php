...
<div class="bg-gray-900 text-white min-h-screen overflow-x-hidden">
    ...
    <div class="relative w-full min-h-screen gradient-dark">
        ...
        <div id="popupModal" class="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-50 hidden">
            <div class="relative bg-black/80 backdrop-blur-lg border border-gray-700 rounded-2xl w-[90%] max-w-4xl p-8 md:p-12 shadow-2xl glow-orange">

                <!-- Close Button -->
                <button onclick="document.getElementById('popupModal').classList.add('hidden')"
                    class="absolute top-6 right-6 w-12 h-12 bg-red-500/20 hover:bg-red-500/40 rounded-full flex items-center justify-center text-2xl text-white hover:text-red-400 transition-all duration-300 transform hover:scale-110 border border-red-500/30">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    <div class="flex flex-col items-center text-center space-y-6">
                        ...
                        <div class="space-y-3">
                            <h3 class="text-2xl font-bold text-gradient">Toyota Calya 2023</h3>
                            <p class="text-xl text-orange-400 font-semibold">Rp. 420.000,00 / hari</p>
                            <div class="star-rating text-lg">
                                @for ($i = 0; $i < 5; $i++)
                                    <i class="fas fa-star"></i>
                                @endfor
                                <span class="text-gray-300 ml-2">4.9/5</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <form class="space-y-6">
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="date" 
                                class="w-full bg-gray-800/50 border-2 border-gray-600 hover:border-orange-400 focus:border-orange-400 rounded-xl px-4 py-3 text-white placeholder-gray-400 transition-colors duration-300 backdrop-blur-sm" />
                        </div>
                        ...
                        <div class="flex flex-col sm:flex-row gap-4 pt-6">
                            <button type="button" 
                                onclick="document.getElementById('popupModal').classList.add('hidden')"
                                class="flex-1 border-2 border-gray-600 hover:border-red-400 hover:bg-red-400/10 text-white font-semibold px-6 py-3 rounded-xl transition-all duration-300 transform hover:scale-105">
                                <i class="fas fa-times mr-2"></i>
                                Batal
                            </button>
                            <a href="/pembayaran"
                                class="flex-1 gradient-orange hover:glow-orange-strong text-white font-semibold px-6 py-3 rounded-xl transition-all duration-300 transform hover:scale-105 text-center pulse-glow">
...
<script>
    ...
    // Modal functionality with date calculation
